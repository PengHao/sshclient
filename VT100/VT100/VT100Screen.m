...
- (void)putToken:(VT100TCC)token
{
   ...
   case VT100_ASCIISTRING:
            ...
            if ([self printToAnsi] == YES)
                [self printStringToAnsi: [NSString stringWithUTF8String:token.u.string]];
            // else display string on screen
            else
                [self setString:[NSString stringWithUTF8String:token.u.string] ascii: token.type == VT100_ASCIISTRING];
            break;
