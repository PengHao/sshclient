...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil) {
        ...
        self.fontMetrics = [[FontMetrics alloc] initWithFont:font];
        [self clearSelection];
        ...
        tableViewController.fontMetrics = self.fontMetrics;
...
- (void)layoutSubviews
{
    ...
    CGSize glyphSize = [self.fontMetrics boundingBox];
